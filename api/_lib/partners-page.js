...
function problemSolutionBandHtml() {
  return `<div class="pt-band pt-band-tint rv">
    ...
    <div class="pt-steps5">
      ${['Найти публикацию', 'Прочитать большой текст', 'Найти свою улицу', 'Найти дом', 'Понять сроки']
        .map((s, i) => `<div class="pt-steps5-item"><span class="pt-steps5-n">${i + 1}</span>${esc(s)}</div>`).join('')}
    </div>
