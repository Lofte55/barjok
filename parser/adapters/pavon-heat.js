...
// ⚠️ РУЧНОЕ ИСКЛЮЧЕНИЕ (2026-08-17): статья pavon.kz обещала подключение ГВС «до 20
// августа» по Сатпаева/Лермонтова, но воду дали раньше срока — сама статья на сайте
// не обновляется задним числом, поэтому парсер продолжал бы каждый час выдумывать
// это отключение заново. Раз пользователь подтвердил факт восстановления — глушим
// эти конкретные адреса из ЭТОЙ статьи здесь, а не правкой map/data.json (которую
// перезатирает следующий прогон). Снять исключение, когда статья устареет сама
// (после 20.08) — можно просто удалить блок, действие ограничено датой end.
const EARLY_RESTORED = new Set([
  'улица Академика Сатпаева, 11', 'улица Академика Сатпаева, 15', 'улица Академика Сатпаева, 17',
  'улица Академика Сатпаева, 21', 'улица Академика Сатпаева, 21/1', 'улица Академика Сатпаева, 25',
  'улица Академика Сатпаева, 27', 'улица Академика Сатпаева, 29', 'улица Академика Сатпаева, 30',
  'улица Академика Сатпаева, 32', 'улица Академика Сатпаева, 33', 'улица Академика Сатпаева, 34',
  'улица Академика Сатпаева, 35', 'улица Академика Сатпаева, 36', 'улица Академика Сатпаева, 37',
  'улица Академика Сатпаева, 38', 'улица Академика Сатпаева, 40', 'улица Академика Сатпаева, 43',
  'улица Академика Сатпаева, 47', 'улица Академика Сатпаева, 57', 'улица Академика Сатпаева, 59',
  'улица Лермонтова, 4', 'улица Лермонтова, 44', 'улица Лермонтова, 45', 'улица Лермонтова, 46',
  'улица Лермонтова, 47', 'улица Лермонтова, 48', 'улица Лермонтова, 49', 'улица Лермонтова, 59',
  'улица Лермонтова, 60', 'улица Лермонтова, 62', 'улица Лермонтова, 82', 'улица Лермонтова, 83',
  'улица Лермонтова, 84', 'улица Лермонтова, 84/1', 'улица Лермонтова, 85', 'улица Лермонтова, 86',
  'улица Лермонтова, 87', 'улица Лермонтова, 87/1', 'улица Лермонтова, 88', 'улица Лермонтова, 89',
  'улица Лермонтова, 94', 'улица Лермонтова, 96', 'улица Лермонтова, 107', 'улица Лермонтова, 107/1',
  'улица Лермонтова, 109', 'улица Лермонтова, 111', 'улица Лермонтова, 113', 'улица Лермонтова, 120',
  'улица Лермонтова, 125',
]);
  ...
  for (const sec of parsed) {
    ...
    for (const a of sec.addrs) {
      ...
      for (const hn of a.houses) {
        ...
        if (EARLY_RESTORED.has(address)) continue;
